...
public class UltrabeastInfos extends CommandBase implements ICommand
{
	...
	public UltrabeastInfos(){
        aliases = Lists.newArrayList("ub");
    }
    ...
    public void execute(@Nonnull MinecraftServer server, @Nonnull ICommandSender sender, @Nonnull String[] args) {
        ...
        for (WorldServer world : server.worlds) {
            ...
            entityList.forEach(entity -> {
                if (entity instanceof EntityPixelmon){
                    ...
                    if (EnumSpecies.ultrabeasts.contains(pixelmon.getPokemonName()) && !pixelmon.hasOwner() && !pixelmon.isBossPokemon()){
                        ...
                        if (cont){
                            ...
                            if (pixelmon.getEntityWorld().getClosestPlayerToEntity(pixelmon,100) != null){
                                ...
                                String keytransform = cfglang.get("ultrabeastlist").getString()
                                        .replace("{ubname}", pixelmon.getLocalizedName())
        ...
        if (!found.get()){
            sender.sendMessage(new TextComponentString(TextFormatting.RED + "No ultrabeast found !"));
        }
    }
